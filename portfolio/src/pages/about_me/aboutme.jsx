  ...
  return (
    <div className='aboutme'>
       <div class="mariel">
          ...
          <p> Hi my name is Mar! I'm a full stack developer who loves to create experiences. I currently work at <a href="http://mercury.io/" className='mercury'>Mercury Intermedia</a> building APIs and UI for clients.</p>
          <div class="contactus">
